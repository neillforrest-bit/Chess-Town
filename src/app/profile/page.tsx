...
export default function ProfilePage() {
  ...
  return <main className="profile-page">
    ...
    <section className="profile-actions"><Link href="/chester-challenge">Chester Challenge</Link><Link href="/arena?view=mini-games">Player Map</Link><Link href="/arena?view=play">Play Chester</Link></section>
  </main>;
}