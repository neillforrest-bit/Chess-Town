...
function PlayChesterGame() {
  ...
  useEffect(() => {
    ...
    const exchangeFact = coachPrompt.exchangeLost && coachPrompt.exchangeWon
      ? ` PLANNED EXCHANGE: the student's move lets Chester win ${coachPrompt.exchangeLost}, but the student's scripted recapture wins ${coachPrompt.exchangeWon} back - the trade profits the student. Recognise the plan and praise the foresight; never call the lost piece a blunder.`
      : '';
